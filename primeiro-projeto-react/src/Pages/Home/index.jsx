            ...
            <div id="body">
                    ...
                    <div id="container-texto-card1">
                        ...
                        <a href="#home-card2">
                            <button id="container-botao-card1">
                                ...
                                <span id="botao1" className='publicSans400 height14 size12 letterSpace2 white1'
                ...
                <div id="home-card2">
                    ...
                    <div id="container-sobre-mim">
                        <h2 id="titulo-sobre-mim" className='ibarraReal700 height42 size40 black1'>Sobre mim</h2>

                        <p id="p-sobre-mim" className='black2 publicSans400 height30 size16 ' >Sou um desenvolvedor front-end júnior procurando por uma oportunidade. Eu foco em
                        ...
                        <button onClick={() => handlePageState('portfolio')} id="botao2" className='publicSans400 height14 size12 letterSpace2'> IR PARA PORTIFÓLIO</button>
                    </div>
